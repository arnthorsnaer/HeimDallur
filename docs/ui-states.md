...
HEIMDALLUR  2026-06-29 00:16:27 UTC

INTERNET  ✓ Online  22ms  excellent
  IP 3/3  ·  DNS 3/3  ·  HTTP 3/3
  All paths healthy
  ↓ 403 Mbps  ·  ping 12 ms  (0s ago)
...
**Probed:** 2026-06-29 00:16:27 UTC  |  **Interval:** 30s
...
**Status:** ✅ HEALTHY  |  **Latency (ONT):** 55 ms avg (elevated)  |  **Loss:** 0%
...
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 67 ms | 79 ms |
| Google | ✅ Online | 53 ms | 71 ms |
| Microsoft | ✅ Online | 51 ms | 57 ms |

**Speed test:** ↓ 224 Mbps  |  ping 24 ms  *(0s ago)*
...
**Status:** ❌ UNREACHABLE  |  **Latency (ONT):** 126 ms avg (degraded)  |  **Loss:** 0%

### IP Reachability

| Target | Status | Latency |
|--------|--------|---------|
| Cloudflare (1.1.1.1) | ❌ unreachable | 183 ms |
| Google (8.8.8.8) | ❌ unreachable | 107 ms |
...
| Resolver | Status | Lookup |
|----------|--------|--------|
| Cloudflare (cloudflare.com) | ✅ Online | 99 ms |
| Google (google.com) | ✅ Online | 72 ms |
| Quad9 (quad9.net) | ✅ Online | 111 ms |

### HTTP

| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 296 ms | 343 ms |
| Google | ✅ Online | 375 ms | 421 ms |
| Microsoft | ✅ Online | 354 ms | 381 ms |

**Speed test:** ↓ 234 Mbps  |  ping 33 ms  *(0s ago)*
...
**Speed test:** ↓ 471 Mbps  |  ping 16 ms  *(0s ago)*
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 62 ms | 82 ms |
| Google | ✅ Online | 81 ms | 102 ms |
| Microsoft | ✅ Online | 41 ms | 49 ms |

**Speed test:** ↓ 448 Mbps  |  ping 32 ms  *(0s ago)*
...
INTERNET  ✓ Online  40ms  excellent
  IP 3/3  ·  DNS 3/3  ·  HTTP 3/3
  All paths healthy
  ↓ 305 Mbps  ·  ping 11 ms  (0s ago)
...
**Status:** ✅ HEALTHY  |  **Latency (ONT):** 20 ms avg (excellent)  |  **Loss:** 0%
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 66 ms | 77 ms |
| Google | ✅ Online | 72 ms | 92 ms |
| Microsoft | ✅ Online | 79 ms | 85 ms |

**Speed test:** ↓ 417 Mbps  |  ping 15 ms  *(0s ago)*
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 65 ms | 81 ms |
| Google | ✅ Online | 54 ms | 75 ms |
| Microsoft | ✅ Online | 36 ms | 53 ms |

**Speed test:** ↓ 414 Mbps  |  ping 17 ms  *(0s ago)*
...
**Status:** ✅ HEALTHY  |  **Latency:** 1 ms
**CPU:** 6%  |  **Memory:** 39%  |  **Uptime:** 3d

### Groups

#### WiFi Garage

**Gateway `192.0.2.25`:** ❌ 178 ms
