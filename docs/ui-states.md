...
HEIMDALLUR  2026-06-19 17:59:43 UTC

INTERNET  ✓ Online  32ms  excellent
  IP 3/3  ·  DNS 3/3  ·  HTTP 3/3
  All paths healthy
  ↓ 300 Mbps  ·  ping 28 ms  (0s ago)
...
**Probed:** 2026-06-19 17:59:43 UTC  |  **Interval:** 30s
...
**Status:** ✅ HEALTHY  |  **Latency (ONT):** 50 ms avg (excellent)  |  **Loss:** 0%
...
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 48 ms | 59 ms |
| Google | ✅ Online | 63 ms | 82 ms |
| Microsoft | ✅ Online | 68 ms | 91 ms |

**Speed test:** ↓ 184 Mbps  |  ping 21 ms  *(0s ago)*
...
| Target | Status | Latency |
|--------|--------|---------|
| Cloudflare (1.1.1.1) | ❌ unreachable | 151 ms |
...
| Resolver | Status | Lookup |
|----------|--------|--------|
| Cloudflare (cloudflare.com) | ✅ Online | 122 ms |
| Google (google.com) | ✅ Online | 118 ms |
| Quad9 (quad9.net) | ✅ Online | 90 ms |

### HTTP

| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 327 ms | 359 ms |
| Google | ✅ Online | 319 ms | 341 ms |
| Microsoft | ✅ Online | 358 ms | 392 ms |

**Speed test:** ↓ 209 Mbps  |  ping 20 ms  *(0s ago)*
...
**Speed test:** ↓ 376 Mbps  |  ping 27 ms  *(0s ago)*
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 57 ms | 64 ms |
| Google | ✅ Online | 35 ms | 51 ms |
| Microsoft | ✅ Online | 59 ms | 83 ms |

**Speed test:** ↓ 334 Mbps  |  ping 14 ms  *(0s ago)*
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 49 ms | 64 ms |
| Google | ✅ Online | 56 ms | 76 ms |
| Microsoft | ✅ Online | 58 ms | 79 ms |

**Speed test:** ↓ 207 Mbps  |  ping 25 ms  *(0s ago)*
...
INTERNET  ✓ Online  24ms  excellent
  IP 3/3  ·  DNS 3/3  ·  HTTP 3/3
  All paths healthy
  ↓ 324 Mbps  ·  ping 9 ms  (0s ago)

HOME NETWORK
  ROUTER  ✓ Online  3ms
  ✗ Offline  165ms  WiFi Garage
...
**Status:** ✅ HEALTHY  |  **Latency (ONT):** 19 ms avg (excellent)  |  **Loss:** 0%
...
| Endpoint | Status | TTFB | Total |
|----------|--------|------|-------|
| Cloudflare | ✅ Online | 67 ms | 89 ms |
| Google | ✅ Online | 62 ms | 84 ms |
| Microsoft | ✅ Online | 75 ms | 92 ms |

**Speed test:** ↓ 406 Mbps  |  ping 16 ms  *(0s ago)*
